...
> **Welcome to Product-Track Week 10, Task 7!**
...
| `src/gradeCalculator.py` | Main source code - **has bugs to fix** |
| `src/gradeUtils.py` | Supporting code - **may also have bugs** |
| `tests/test_grades.py` | Test file - **add your tests here** |
...
### Incident - `src/gradeCalculator.py`
**User Report / Alert:**
> "(no marker): AVG() returns None for students with no grades (Charlie)"
...
### Incident - `src/gradeCalculator.py`
**User Report / Alert:**
> "(no marker): Uses > instead of >= for boundaries"
...
### Incident - `src/gradeCalculator.py`
**User Report / Alert:**
> "(no marker): Simple average instead of weighted by credits"
...
### Incident - `src/gradeCalculator.py`
**User Report / Alert:**
> "(no marker): Sorts ascending (lowest first) instead of descending"
